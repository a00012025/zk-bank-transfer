...
template FubonTransferRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[9] <== eq[0][i].out;
		multi_or[0][i].in[10] <== eq[3][i].out;
		and[79][i].b <== multi_or[0][i].out;
		and[80][i] = AND();
		and[80][i].a <== states[i][80];
		and[80][i].b <== multi_or[0][i].out;
		multi_or[1][i] = MultiOR(2);
		multi_or[1][i].in[0] <== and[79][i].out;
		multi_or[1][i].in[1] <== and[80][i].out;
		states[i+1][80] <== multi_or[1][i].out;
		state_changed[i].in[79] <== states[i+1][80];
		and[81][i] = AND();
		and[81][i].a <== states[i][54];
		and[81][i].b <== eq[0][i].out;
		states[i+1][81] <== and[81][i].out;
		state_changed[i].in[80] <== states[i+1][81];
		and[82][i] = AND();
		and[82][i].a <== states[i][81];
		and[82][i].b <== eq[2][i].out;
		states[i+1][82] <== and[82][i].out;
		state_changed[i].in[81] <== states[i+1][82];
		and[83][i] = AND();
		and[83][i].a <== states[i][82];
		and[83][i].b <== eq[13][i].out;
		states[i+1][83] <== and[83][i].out;
		state_changed[i].in[82] <== states[i+1][83];
		and[84][i] = AND();
		and[84][i].a <== states[i][83];
		and[84][i].b <== eq[14][i].out;
		states[i+1][84] <== and[84][i].out;
		state_changed[i].in[83] <== states[i+1][84];
		and[85][i] = AND();
		and[85][i].a <== states[i][84];
		and[85][i].b <== eq[2][i].out;
		states[i+1][85] <== and[85][i].out;
		state_changed[i].in[84] <== states[i+1][85];
		and[86][i] = AND();
		and[86][i].a <== states[i][85];
		and[86][i].b <== eq[15][i].out;
		states[i+1][86] <== and[86][i].out;
		state_changed[i].in[85] <== states[i+1][86];
		and[87][i] = AND();
		and[87][i].a <== states[i][86];
		and[87][i].b <== eq[7][i].out;
		states[i+1][87] <== and[87][i].out;
		state_changed[i].in[86] <== states[i+1][87];
		and[88][i] = AND();
		and[88][i].a <== states[i][87];
		and[88][i].b <== eq[2][i].out;
		states[i+1][88] <== and[88][i].out;
		state_changed[i].in[87] <== states[i+1][88];
		and[89][i] = AND();
		and[89][i].a <== states[i][88];
		and[89][i].b <== eq[0][i].out;
		states[i+1][89] <== and[89][i].out;
		state_changed[i].in[88] <== states[i+1][89];
		and[90][i] = AND();
		and[90][i].a <== states[i][89];
		and[90][i].b <== eq[3][i].out;
		states[i+1][90] <== and[90][i].out;
		state_changed[i].in[89] <== states[i+1][90];
		and[91][i] = AND();
		and[91][i].a <== states[i][90];
		and[91][i].b <== eq[2][i].out;
		states[i+1][91] <== and[91][i].out;
		state_changed[i].in[90] <== states[i+1][91];
		and[92][i] = AND();
		and[92][i].a <== states[i][91];
		and[92][i].b <== eq[5][i].out;
		states[i+1][92] <== and[92][i].out;
		state_changed[i].in[91] <== states[i+1][92];
		and[93][i] = AND();
		and[93][i].a <== states[i][92];
		and[93][i].b <== eq[16][i].out;
		states[i+1][93] <== and[93][i].out;
		state_changed[i].in[92] <== states[i+1][93];
		and[94][i] = AND();
		and[94][i].a <== states[i][93];
		and[94][i].b <== eq[2][i].out;
		states[i+1][94] <== and[94][i].out;
		state_changed[i].in[93] <== states[i+1][94];
		and[95][i] = AND();
		and[95][i].a <== states[i][94];
		and[95][i].b <== eq[15][i].out;
		states[i+1][95] <== and[95][i].out;
		state_changed[i].in[94] <== states[i+1][95];
		and[96][i] = AND();
		and[96][i].a <== states[i][95];
		and[96][i].b <== eq[0][i].out;
		states[i+1][96] <== and[96][i].out;
		state_changed[i].in[95] <== states[i+1][96];
		and[97][i] = AND();
		and[97][i].a <== states[i][96];
		and[97][i].b <== eq[2][i].out;
		states[i+1][97] <== and[97][i].out;
		state_changed[i].in[96] <== states[i+1][97];
		and[98][i] = AND();
		and[98][i].a <== states[i][97];
		and[98][i].b <== eq[15][i].out;
		states[i+1][98] <== and[98][i].out;
		state_changed[i].in[97] <== states[i+1][98];
		and[99][i] = AND();
		and[99][i].a <== states[i][98];
		and[99][i].b <== eq[17][i].out;
		states[i+1][99] <== and[99][i].out;
		state_changed[i].in[98] <== states[i+1][99];
		and[100][i] = AND();
		and[100][i].a <== states[i][99];
		and[100][i].b <== eq[2][i].out;
		states[i+1][100] <== and[100][i].out;
		state_changed[i].in[99] <== states[i+1][100];
		and[101][i] = AND();
		and[101][i].a <== states[i][100];
		and[101][i].b <== eq[5][i].out;
		states[i+1][101] <== and[101][i].out;
		state_changed[i].in[100] <== states[i+1][101];
		and[102][i] = AND();
		and[102][i].a <== states[i][101];
		and[102][i].b <== eq[3][i].out;
		states[i+1][102] <== and[102][i].out;
		state_changed[i].in[101] <== states[i+1][102];
		and[103][i] = AND();
		and[103][i].a <== states[i][102];
		and[103][i].b <== eq[2][i].out;
		states[i+1][103] <== and[103][i].out;
	...
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][80];
	}
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][80] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
		is_consecutive[msg_bytes-1-i][1] <== state_changed[msg_bytes-i].out * is_consecutive[msg_bytes-1-i][0];
	}
	// substrings calculated: [{(80, 80), (79, 80)}]
	signal is_substr0[msg_bytes][3];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][79] * states[i+2][80];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][80] * states[i+2][80];
